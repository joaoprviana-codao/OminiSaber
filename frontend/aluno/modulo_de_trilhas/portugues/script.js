(() => {
  const progress = window.OminiPortuguese.getProgress();
  ...
  document.addEventListener('ominisaber:ready', loadFeed); document.addEventListener('DOMContentLoaded', () => { if (!window.OminiSaber?.configured) loadFeed(); });
})();
