...
select * from (values
  ...
  ('Física em Movimento', 'Coleção EduTech', 'Científico / Técnico', 'Didáticos', 'Um guia visual para compreender movimento, energia e as leis que conectam teoria e experiências cotidianas.', 142, 'força, energia, velocidade'),
  ('A célula por dentro', 'Coleção EduTech', 'Científico / Técnico', 'Apostilas', 'Diagramas e explicações para investigar as estruturas celulares e os processos que sustentam a vida.', 96, 'célula, genética, vida'),
  ('Álgebra para pensar', 'Coleção EduTech', 'Didático', 'Didáticos', 'Problemas graduais, estratégias e exemplos para transformar relações algébricas em ferramentas de raciocínio.', 188, 'equações, álgebra, problemas')
